...
void SAVE(void)	
{
  ...
  if(flag_shockexperiment==1)
  {
    ...
    inv_res << 1-U(1);                                                                          // 5
    inv_res.width(60);
    inv_res << cpi(1)/cpi(2);                                                                   // 6
    inv_res.width(60);
    inv_res << Emiss1_TOT+Emiss2_TOT+Emiss_en;                                                  // 7  
    inv_res.width(60);
    inv_res << D_en_TOT(1);                                                                     // 8
    inv_res.width(60);
    inv_res << LS;                                                                              // 9
    inv_res.width(60);
    inv_res << K.Sum();                                                                         // 10
    inv_res.width(60);
    inv_res << A1p_en_dead/A1p_en_survive;                                                      // 11
    inv_res.width(60);
    inv_res << A2_en_dead/A2_en_survive;                                                        // 12
    inv_res.width(60);
    inv_res << Am_en(1);                                                                        // 13
    inv_res.width(60);
    inv_res << Am_a;                                                                            // 14
    ...
    inv_res.width(60);
    inv_res << CreditDemand_all/CreditSupply_all;                                               // 29
    inv_res.width(60);
    ...
    inv_res.width(60);
    inv_res << min(1.0,counter_bankfailure);                                                    // 33
    inv_res.width(60);
    inv_res << cpi(1);                                                                          // 34
    inv_res.width(60);
    inv_res << exp_quota;                                                                       // 35
    inv_res.width(60);
    ...
    inv_res << GDP_n(1);                                                                        // 39
    inv_res.width(60);
    inv_res << Investment_n*dim_mach*a;                                                         // 40
    inv_res.width(60);
    inv_res << Consumption;                                                                     // 41
    inv_res.width(60);
    inv_res << t_CO2_en;                                                                        // 42
    inv_res.width(60);
    inv_res << ReplacementInvestment_r;                                                         // 43
    inv_res.width(60);
    ...
    inv_res.width(60);
    inv_res << K_gelag/(K_gelag+K_delag);                                                       // 50
    inv_res.width(60);
    ...
    inv_res.width(60);
    inv_res << exit_payments2.Sum()+exit_equity2.Sum();                                         // 64
    inv_res.width(60);
    inv_res << Pitot1+Pitot2;                                                                   // 65
    inv_res.width(60);
    ...
    inv_res.width(60);
    inv_res << (cpi(1)/cpi(5))-1;                                                               // 71
    inv_res.width(60);
    inv_res << pow(GDP_r(1)/GDP_r(2),4)-1;                                                      // 72
    inv_res.width(60);
    inv_res << NW_f(1)/(GDP_n(1)*4);                                                            // 73
    inv_res.width(60);
    inv_res << Wages/(Pitot1+Pitot2+BankProfits.Sum()+ProfitEnergy+FuelCost+Wages)<<endl;       // 74
    inv_res.close();
