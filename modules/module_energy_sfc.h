...
// -- Regions (derivative accounting) -- //
extern int NR;
extern RowVector region_energy_dirty_shares;
extern RowVector region_energy_green_shares;
extern RowVector ge_growth_probability;
