...
extern std::vector<std::vector<double>> b_0_regional;            // [nshocks][NR]
extern std::vector<std::vector<double>> shockexponent1_regional; // [nshocks][NR] - OVERRIDES scalar when NR>0
extern std::vector<std::vector<double>> shockexponent2_regional; // [nshocks][NR] - OVERRIDES scalar when NR>0

extern std::vector<int> region_firm_assignment_K; // Region index for each K-firm
extern std::vector<int> region_firm_assignment_C; // Region index for each C-firm
extern std::vector<double> regional_shock_value;  // One shock scalar per region (size NR)
...
extern Matrix X_a_reg; // Regional disaster params (nshocks × NR)
extern Matrix X_b_reg; // Regional disaster params (nshocks × NR)
...
// Adaptation dampening (set by RG_BLOCK_FISCAL, used by SHOCKS/SINGLESHOCK)
